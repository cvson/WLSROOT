...
// ********************************************************************
//
/// \file analysis/WLSROOT/src/SCIBARHistoManager.cc
/// \brief Implementation of the SCIBARHistoManager class
//
//
// $Id: SCIBARHistoManager.cc 92443 2015-09-01 13:56:16Z gcosmo $
// 
...
SCIBARHistoManager::SCIBARHistoManager()
 : fFactoryOn(false)
{}
...
void SCIBARHistoManager::Book()
{
  // Create or get analysis manager
  // The choice of analysis technology is done via selection of a namespace
  // in SCIBARHistoManager.hh
  ...
  if (! fileOpen) {
    G4cerr << "\n---> SCIBARHistoManager::Book(): cannot open " 
...
void SCIBARHistoManager::FillHisto(G4int ih, G4double xbin, G4double weight)
{
  G4AnalysisManager* analysisManager = G4AnalysisManager::Instance(); 
...
void SCIBARHistoManager::Normalize(G4int ih, G4double fac)
{
  G4AnalysisManager* analysisManager = G4AnalysisManager::Instance(); 
...
void SCIBARHistoManager::FillNtuple(G4double energyDep,  G4double trackLDep)
{                
  G4AnalysisManager* analysisManager = G4AnalysisManager::Instance();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//newadd
void SCIBARHistoManager::FillPrimTrack(G4double xval, G4double yval, G4double zval, G4double pzval, G4double thetaval, G4int nphotopassval, G4int nphotofailval, G4int nphotoscintval, G4int nphotocherenval, G4double enscintval, G4double encherenval)
{
    G4AnalysisManager* analysisManager = G4AnalysisManager::Instance();
...
void SCIBARHistoManager::PrintStatistic()
{
  if (! fFactoryOn) return;
